...
class MyFrame4 extends Frame{
	...
	final double x0 =-5.0;				//初期値x0
	final int N=1000;				//最大反復数
...
public class ParallelViewFrame {
	public static void main(String args[]){
		MyFrame4 f = new MyFrame4("Parallel法の収束状況");	//Frame objectの生成
		f.setSize(MyFrame4.width,MyFrame4.height);				//Windowサイズの設定
